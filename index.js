...
function loadHandlers() {
    db.serialize(function () {
        ...
        db.run('CREATE TABLE IF NOT EXISTS \"cadet_threads\" (\t\"channel_id\"\tTEXT NOT NULL UNIQUE,\t\"message_id\"\tTEXT NOT NULL UNIQUE,\t\"creator\"\tTEXT NOT NULL,\t\"feedback\"\tTEXT NOT NULL,\t\"thumbs_up\"\tINTEGER NOT NULL,\t\"thumbs_down\"\tINTEGER NOT NULL,\t\"is_locked\"\tINTEGER NOT NULL);');
        // Note:
    ...
    let CommandHandler = require('./modules/commandHandler');
    let commandHandler = new CommandHandler();
    commandHandler.registerHandlers();
    handlerList.push(commandHandler);
}
